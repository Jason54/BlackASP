...
class BlackASP extends PluginBase implements CommandExecutor, Listener {
    ...
    public function onEnable()
    {
        ...
        if ($this->getConfig()->get("antiswearwords") || $this->getConfig()->get("antirudenames")) {
            ...
            $this->getLogger()->info(TEXTFORMAT::GREEN . "Filtre AntiSpamPro Swear activé");
        }
    }
    ...
    public function onLogin(PlayerLoginEvent $e)
    {
        ...
        if ($this->getConfig()->get("antirudenames") && $this->profanityfilter->hasProfanity($e->getPlayer()->getName())) {
            $e->getPlayer()->kick("Aucun noms grossiers autorisés");
            $e->setCancelled(true);
        }
    }
